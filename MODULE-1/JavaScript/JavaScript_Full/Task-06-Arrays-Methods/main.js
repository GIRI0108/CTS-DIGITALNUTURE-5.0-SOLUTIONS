...
function showEventDetails(eventCode) {
    ...
    if (eventItem != null) {
        ...
        document.getElementById("eventObjectDetails").scrollIntoView();
    }
}
...
function addEventFromPopup() {
    ...
    if (name == "" || date == "" || location == "" || category == "" || fee == "" || seatsText == "") {
        document.getElementById("arrayOutput").innerHTML = "<p>Please enter all event details.</p>";
        return;
    }
    ...
    if (isNaN(seats) || seats <= 0) {
        document.getElementById("arrayOutput").innerHTML = "<p>Please enter valid seats.</p>";
        return;
    }
