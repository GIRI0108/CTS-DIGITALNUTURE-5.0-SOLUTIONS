...
function showRemoteEvents(remoteEvents, methodName) {
    var remoteEventsContainer = document.querySelector("#remoteEventsContainer");
...
function loadEventsUsingThen() {
    var remoteMessage = document.querySelector("#remoteMessage");
